...
description:
'Tipo de comercio: retailer (minorista) o wholesaler (mayorista)',
})
@IsEnum(ShopType, {
...
@ApiPropertyOptional({
example: '[info@petshop.com](mailto:info@petshop.com)',
...
@ApiPropertyOptional({
example: '[https://www.petshop.com](https://www.petshop.com)',
...
@ApiPropertyOptional({
example:
'{"monday":{"open":"09:00","close":"18:00"},"saturday":{"open":"09:00","close":"13:00"}}',
description:
'Horarios por día (JSON string cuando se envía vía form-data)',
})
@IsOptional()
@Transform(({ value }) => {
...
type: 'string',
format: 'binary',
description: 'Logo del local (imagen)',
})
@IsOptional()
logo?: any;
...
type: 'string',
format: 'binary',
description: 'Banner publicitario (imagen)',
})
@IsOptional()
banner?: any;
}
